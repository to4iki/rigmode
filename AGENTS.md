...
- `rigmode log` lists attach.jsonl (which modes a prompt actually received), the sibling of `rigmode gate` for gates.jsonl. Old-schema lines fail to parse and are skipped.
